...
![vi-editor logo](https://raw.githubusercontent.com/Venkatakoti-lab/Linux/main/images/vi-editor.svg)
...
- inode: Indoe is the representation of file and folder inside the memory it is a number.
   - we use to know the storage location, ownership,permissions of the file.
   - inode = index node
...
![sym-link logo](https://raw.githubusercontent.com/Venkatakoti-lab/Linux/main/images/sym-link.svg)
...
- To extract the .tar.gz file, we use: `tar -xf <.tar.gz file path>`
  ...
  ![hard-link logo](https://raw.githubusercontent.com/Venkatakoti-lab/Linux/main/images/hard-link.svg)
